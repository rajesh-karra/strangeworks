...
export default function HomePage() {
  return (
    <article>
      ...
      {/* Strategic Vision and Manifesto */}
      <section className="border-t border-zinc-100 max-w-5xl mx-auto px-8 py-24 grid md:grid-cols-12 gap-12">
      ...
      <section className="border-t border-zinc-100 bg-zinc-50/40 py-28 px-8">
        <div className="max-w-5xl mx-auto grid md:grid-cols-12 gap-16 items-start">
          ...
          <div className="md:col-span-7 bg-white border border-zinc-200/60 p-2 shadow-sm rounded-none">
            ...
            <video controls className="w-full h-auto aspect-video object-cover bg-black">
